...
% subjects=[105,108,116,127:129]; % Define here your subjects' codes. 101:113,115:124,126,127
% subjects=[105,108,116,127:129]

ALLsubjects=[105,108,116,127:129]; % subject to include
subjects2EXclud= [];
...
for subjInd=1:length(subjects)
    ...
    filename=strcat(outpath,sprintf('ccat_%d',subjects(subjInd)));
